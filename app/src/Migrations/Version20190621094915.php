 ...
 */
final class Version20190621094915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, screenwriter_id INT NOT NULL, director_id INT NOT NULL, author_id INT NOT NULL, country_id INT NOT NULL, title VARCHAR(128) NOT NULL, year INT NOT NULL, rate INT NOT NULL, boxoffice INT NOT NULL, code VARCHAR(64) NOT NULL, INDEX IDX_1D5EF26F12469DE2 (category_id), INDEX IDX_1D5EF26F497437B6 (screenwriter_id), INDEX IDX_1D5EF26F899FB366 (director_id), INDEX IDX_1D5EF26FF675F31B (author_id), INDEX IDX_1D5EF26FF92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(128) NOT NULL, password VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user_data (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, city VARCHAR(45) NOT NULL, age INT NOT NULL, first_name VARCHAR(64) NOT NULL, UNIQUE INDEX UNIQ_D772BFAAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE photo (id INT AUTO_INCREMENT NOT NULL, movie_id INT DEFAULT NULL, file VARCHAR(191) NOT NULL, UNIQUE INDEX UNIQ_14B784188F93B6FC (movie_id), UNIQUE INDEX UQ_photos_1 (file), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE photo ADD CONSTRAINT FK_14B784188F93B6FC FOREIGN KEY (movie_id) REFERENCES movie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP FOREIGN KEY FK_14B784188F93B6FC');
